              ...
              <div class="box-body">
                ...
                <div class="form-group">  
                  <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="product_type" name="product_type" placeholder="Enter product Type" value="<?php echo $product_data['product_type']; ?>"  autocomplete="off" required/>
                  </div>
