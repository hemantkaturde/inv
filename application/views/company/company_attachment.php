...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Company Attachments</li>
    </ol>
  </section>
  <!-- Main content -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeTransModal">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Controller_Company/removeTrans') ?>" method="post" id="removeTransForm">
        <div class="modal-body">
...
$j(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    ...
    'ajax': base_url + 'Controller_Company/fetchCompanyAttachments/'+comp_id,
    'order': []
  });
