...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Manage Inquiry notes

    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Inquiry</li>
      <li class="active">Manage Inquiry notes</li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-10 col-xs-10">
        ...
        <?php endif; ?>
          ...
          <a href="<?php echo base_url('Controller_Inquiry/create_notes/'.$enquiry_id) ?>" class="btn btn-primary">Add Notes</a>
          <a href="" onClick="window.location.href=window.location.href" class="btn btn-warning">Refresh</a>
          <a href="<?php echo base_url('Controller_Inquiry/') ?>" class="btn btn-primary">Back</a>
          <br /> <br />
...
$j(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    ...
    'ajax': base_url + 'Controller_Inquiry/fetchProductData/'+id,
    'order': []
  });
