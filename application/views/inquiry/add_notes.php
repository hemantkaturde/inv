    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-8 col-xs-8">
                ...
                <div class="box">
                    <div class="box-body">
                        <form role="form" action="<?php base_url('Controller_inquiry/create_notes') ?>" method="post">
                            <input type="hidden" class="form-control" id="inquiry_id" name="inquiry_id"
                                    placeholder="Enter date"  value="<?php echo $enquiry_id; ?>">
                            <div class="col-md-4">
                                <label for="company_email1">Inquiry Number</label>
                                <input type="text" class="form-control" id="Inquiry_number"
                                    value="<?php echo $getInquiryDetails[0]['inquiry_number'];?>" name="Inquiry_number"
                                    readonly>
                            </div>
                            <div class="col-md-4">
